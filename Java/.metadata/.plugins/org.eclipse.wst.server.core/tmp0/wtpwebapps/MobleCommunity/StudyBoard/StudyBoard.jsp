          ...
          <table class="table_board" style="border:1px solid #dddddd">
            ...
            <tbody>
							...
							<tr>
								...
								<td class="tableContent2"><%=vo.getFileNo()%></td>
								<td class="tableContent3"><%=vo.getStudyTitle()%></td>
								<td class="tableContent4"><%=vo.getStudyContent()%></td>
								<td class="tableContent5"><%=vo.getFile()%></td>
								<td class="tableContent6"><%=vo.getReg_date()%></td>
							</tr>								
							<%
								}
							%>
