...
public class JPanel2 extends JPanel implements ActionListener {
   ...
   public JPanel2() {
     image = new ImageIcon("C:\\\\Users\\\\moble\\\\eclipse-workspace\\\\teamwork1\\\\수정2.jpg").getImage();
         ...
         if(str.equals("수정")) { //수정기능
            ...
            if(SG.AL.size() < 1) {
               ...
               for(Student stu : SG.AL) {
                  if(stu.getName().equals(tf1.getText()) && stu.getNum().equals(tf2.getText()) || stu.getNum().equals(tf2.getText())) { //만약 AL의 정보중 입력한 이름이 같은 사람이 있다면
                     ta.setText("");
